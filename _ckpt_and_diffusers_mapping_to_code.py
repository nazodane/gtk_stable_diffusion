...
code = """# This code is autogenerated code by _ckpt_and_diffusers_mapping_to_code.py

def ckpt_to_diffusers(checkpoint, unet, vae, text_model):
"""
...
code += code_gen(vae, "vae", vae_ckpt_and_diffusers_mapping_conv, ".reshape((512, 512))")
code += code_gen(text_model, "text_model", text_model_ckpt_and_diffusers_mapping_noconv)
code += code_gen(text_model, "text_model", text_model_ckpt_and_diffusers_mapping_conv, ".long()")
#print(code)
with open("ckpt_to_diffusers.py", "w") as f:
    f.write(code)
